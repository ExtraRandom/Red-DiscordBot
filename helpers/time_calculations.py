...
def calc_from_until(dFrom, rd):
    """
    Calculates the amount of time between 'dFrom' and 'rd'

    :param rd:  release date as datetime()
    :param dFrom: basically replaces utcnow() in calc_until()
    :return:    three strings with time left
    """

    t_delta = rd - dFrom  # datetime.utcnow()
    t_str = str(t_delta)
